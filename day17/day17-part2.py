...
def func(x_end,y_end,array,rows,cols):
    ...
    while heap:
        ...
        if x==x_end and y==y_end and range>=4:
            return dist
        ...
        for i in directions[direction]:                
            ...
            if rows<=x_new or x_new<0 or 0>y_new or y_new>=cols or (x_new,y_new,i,r_new) in memo or r_new>10 or (i!=direction and range<4 and range!=-1):
                continue
